...
* **PCA Visualisation**: Proved that while the data lives in 6 dimensions, the customer behaviours can be effectively mapped and separated in a 2D space which is lower dimensional.
